...
# SECRET_KEY = "django-insecure-y(7r6)0nu&_z4s1o4+^v%2k#&ny4@4=@b0=3@5szlg_n(e)0!&"
...
DEFAULT_FROM_EMAIL = getenv("AWS_SES_FROM_EMAIL")  # for djoser
...
SITE_NAME = (
    "Full Auth"  # it is here because it will be the same in development and production
)
...
# These settings are only for production (dont have to have them in .env.local for now)
if DEVELOPMENT_MODE is True:
    ...
    # not needed since settings higher do not require Amazon Web Services
    """ 
    GS_CREDENTIALS = service_account.Credentials.from_service_account_file(os.path.join(BASE_DIR, 'the-name-of-your-json-file.json'))
    DEFAULT_FILE_STORAGE = 'storages.backends.gcloud.GoogleCloudStorage'
    GS_BUCKET_NAME = getenv("GS_BUCKET_NAME")
    #GS_OBJECT_PARAMETERS = {"cache_control": "max-age=86400"} #?
